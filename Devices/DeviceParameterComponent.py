...
""" 
Ubermap alpha v0.1: modified DeviceParameterComponent.py
--------------------------------------------------------
This file has had a small modification made to enable custom parameter names.
For more information, see Devices.py 

Modified section is marked with "*** [Start/End] td modifications ***"
"""
